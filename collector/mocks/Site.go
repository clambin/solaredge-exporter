...
func (_e *Site_Expecter) GetInverters(ctx interface{}) *Site_GetInverters_Call {
	return &Site_GetInverters_Call{Call: _e.mock.On("GetInverters", ctx)}
}

func (_c *Site_GetInverters_Call) Run(run func(ctx context.Context)) *Site_GetInverters_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Site_GetInverters_Call) Return(_a0 []solaredge.Inverter, _a1 error) *Site_GetInverters_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Site_GetInverters_Call) RunAndReturn(run func(context.Context) ([]solaredge.Inverter, error)) *Site_GetInverters_Call {
	_c.Call.Return(run)
	return _c
}
